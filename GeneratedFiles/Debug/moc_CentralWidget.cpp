...
const QMetaObject CentralWidget::staticMetaObject = {
    { &osgEarth::QtGui::ViewerWidget::staticMetaObject, qt_meta_stringdata_CentralWidget.data,
...
void *CentralWidget::qt_metacast(const char *_clname)
{
    ...
    return osgEarth::QtGui::ViewerWidget::qt_metacast(_clname);
}

int CentralWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = osgEarth::QtGui::ViewerWidget::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    return _id;
}
