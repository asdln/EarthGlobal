...
osg::Node* g_earthNode = NULL;

class ViewerWidget : public QWidget, public osgViewer::CompositeViewer
{
public:
	ViewerWidget(osgEarth::QtGui::ViewerWidget* pCentralWidget, QWidget* parent = 0, Qt::WindowFlags f = 0, osgViewer::ViewerBase::ThreadingModel threadingModel = osgViewer::CompositeViewer::SingleThreaded) : QWidget(parent, f)
	{
		...
		grid->addWidget(pCentralWidget, 1, 1);
		setLayout( grid );
...
int main_Ex( int argc, char** argv )
{
	...
	g_earthNode = osgDB::readNodeFiles(arguments);
	if (!g_earthNode)
		return 0;
	
	QApplication app(argc, argv);
	ViewerWidget* viewWidget = new ViewerWidget(NULL, 0, Qt::Widget, threadingModel);
